...
for k in range(len(reduc_list)):
	...
	paths_to_fits = np.array(pd.read_csv("reductions_lists/"+reduc_list[k]+"_files.txt",header=None))
	matched = pd.read_csv("psrc_lists/matched_18arcsec_1and2_best1_vlass.csv")
