...
injected_found = pd.read_csv("../psrc_lists/injected_2_6_psrcs__2aspcmsubqm2_fitel_0f09-to-35f5Hz_qc_0p6rr_M_PdoCals_dt20_snr_iter1_5.0sigma.csv")
...
for i in ff:
	...
	plt.savefig("../psrc_img_injected/"+str(c)+"_injected_found.png")
	plt.close(fig)
